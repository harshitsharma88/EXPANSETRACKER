...
async function getAll() {
    ...
    try {
        ...
        const result = await axios.get(`http://3.80.38.126:80/expanse/get-expanse/${itemsperpage}/${currentpage}`,{headers:{Authorazation:token}})
...
async function handleAddExpanse(event){
    ...
    try {
        ...
        const result= await axios.post('http://3.80.38.126:80/expanse/add-expanse',expanseObj,{headers:{Authorazation:token}});
...
function display(object){
    ...
    method:'delete',
    url:'http://3.80.38.126:80/expanse/delete-expanse',
    data:object,
...
document.querySelector('#rzrbtn').onclick=async (e)=>{
    ...
    try {
        const response = await axios.get('http://3.80.38.126:80/purchase/premiummembership',{headers:{Authorazation:token}});
        const options={
            ...
            "handler":async (rzpresponse)=>{
                ...
                const res=await axios.post('http://3.80.38.126:80/purchase/updatepremium',{
    ...
    rzp.on('payment.failed',async(issue)=>{
        console.log(issue);
        await axios.post('http://3.80.38.126:80/purchase/failedpremium',{orderid:options.order_id,});
...
async function leaderboardreport(){
    try {
        const response = await axios.get('http://3.80.38.126:80/premium/showleaderboard');
...
async function downloadReport(){
    ...
    try {
        ...
        const response = await axios.get('http://3.80.38.126:80/premium/downloadreport',{headers:{Authorazation:token}});
